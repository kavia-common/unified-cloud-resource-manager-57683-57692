...
export default function PieChart({
  ...
  const labelFor = (seg) => {
    ...
    const catFont = {
      fontSize: size >= 480 ? 12 : size < 320 ? 10 : 11,
      fontWeight: 400,
    };
    const pctFont = {
      fontSize: size >= 480 ? 14 : size < 320 ? 12 : 12,
      fontWeight: 600,
    };
  ...
  return (
    ...
    >
      ...
      >
        ...
        {/* Shift donut slightly left to provide more room for right-side labels */}
        <g clipPath="url(#donutClip)" transform="translate(-10, 0)">
          {/* Draw ring segments */}
